...
<body class="bg-light">
	<div class="container py-5">
		<nav class="mb-4 nav">
			...
			<a class="active" href="<?= base_url('contact') ?>">Contact</a>
		</nav>
		<div class="row">
			<div class="col-lg-8 mx-auto">
				<div class="card p-4">
					<h1 class="mb-3">Contact</h1>
					<p class="text-muted">This is the contact page.</p>
					<p class="mb-0">Email us at example@example.com or reach us via the form.</p>
				</div>
			</div>
		</div>
	</div>
